...
class RscollectionrsExclistnodexml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\salesServicePrices\RsExclistnodexml::class],
        ]);
    }
}
...
class RscollectionrsExclistnodevalxm extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesServicePrices\RsExclistnodevalxm::class],
        ]);
    }
}
...
class RscollectionrsPrcdivlstxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesServicePrices\RsPrcdivlstxml::class],
        ]);
    }
}
...
class RsExclistnodexml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'VALREFSLIST' => \LogoObjects\Clients\salesServicePrices\RscollectionrsExclistnodevalxm::class,
        ]);
    }
}
 ...
 * SalesServicePrices
 */
class SalesServicePrices extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'VGENXMLLIST' => \LogoObjects\Clients\salesServicePrices\RscollectionrsExclistnodexml::class,
            'DIVISION_LIST' => \LogoObjects\Clients\salesServicePrices\RscollectionrsPrcdivlstxml::class,
        ]);
    }
}
 ...
 */
class SalesServicePricesQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var SalesServicePricesSortSpec|null */
    public $sort = null;
}
 ...
 */
class SalesServicePricesSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class SalesServicePricesAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
