...
class RscollectionrsPaylstxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\purchaseProposalOrders\RsPaylstxml::class],
        ]);
    }
}
...
class RscollectionrsDiscpaytrxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchaseProposalOrders\RsDiscpaytrxml::class],
        ]);
    }
}
...
class RscollectionrsPurchoffertransx extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchaseProposalOrders\RsPurchoffertransx::class],
        ]);
    }
}
...
class RscollectionrsCampcodeslistxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchaseProposalOrders\RsCampcodeslistxml::class],
        ]);
    }
}
...
class RscollectionrsPurchofferdetxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchaseProposalOrders\RsPurchofferdetxml::class],
        ]);
    }
}
...
class Rscollectionextendedfielddefinitions extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchaseProposalOrders\ExtendedFieldDefinitions::class],
        ]);
    }
}
...
class RsPaylstxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'DISCTRLIST' => \LogoObjects\Clients\purchaseProposalOrders\RscollectionrsDiscpaytrxml::class,
        ]);
    }
}
...
class RsPurchoffertransx extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'CAMPAIGN_INFOS' => \LogoObjects\Clients\purchaseProposalOrders\RscollectionrsCampcodeslistxml::class,
            'DETAILS' => \LogoObjects\Clients\purchaseProposalOrders\RscollectionrsPurchofferdetxml::class,
            'DEFNFLDS' => \LogoObjects\Clients\purchaseProposalOrders\Rscollectionextendedfielddefinitions::class,
        ]);
    }
}
 ...
 */
class PurchaseProposalOrders extends \LogoObjects\Types\BaseEntity
{
    /** @var int|float|null */
    public $TRCODE = null;
    ...
    {
        return array_merge(parent::casts(), [
            'PAYMENT_LIST' => \LogoObjects\Clients\purchaseProposalOrders\RscollectionrsPaylstxml::class,
            'TRANSACTIONS' => \LogoObjects\Clients\purchaseProposalOrders\RscollectionrsPurchoffertransx::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\purchaseProposalOrders\Rscollectionextendedfielddefinitions::class,
        ]);
    }
}
 ...
 */
class PurchaseProposalOrdersQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var PurchaseProposalOrdersSortSpec|null */
    public $sort = null;
}
 ...
 */
class PurchaseProposalOrdersSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class PurchaseProposalOrdersAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
