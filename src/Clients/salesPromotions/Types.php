...
class RscollectionrsPrombundlexml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\salesPromotions\RsPrombundlexml::class],
        ]);
    }
}
 ...
 * SalesPromotions
 */
class SalesPromotions extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'BUNDLES' => \LogoObjects\Clients\salesPromotions\RscollectionrsPrombundlexml::class,
        ]);
    }
}
 ...
 */
class SalesPromotionsQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var SalesPromotionsSortSpec|null */
    public $sort = null;
}
 ...
 */
class SalesPromotionsSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class SalesPromotionsAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
