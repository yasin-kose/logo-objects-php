...
class RscollectionrsPaylstxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\salesContracts\RsPaylstxml::class],
        ]);
    }
}
...
class RscollectionrsDiscpaytrxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesContracts\RsDiscpaytrxml::class],
        ]);
    }
}
...
class RscollectionrsPurchoffertransx extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesContracts\RsPurchoffertransx::class],
        ]);
    }
}
...
class RscollectionrsCampcodeslistxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesContracts\RsCampcodeslistxml::class],
        ]);
    }
}
...
class RscollectionrsPurchofferdetxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesContracts\RsPurchofferdetxml::class],
        ]);
    }
}
...
class Rscollectionextendedfielddefinitions extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesContracts\ExtendedFieldDefinitions::class],
        ]);
    }
}
...
class RsPaylstxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'DISCTRLIST' => \LogoObjects\Clients\salesContracts\RscollectionrsDiscpaytrxml::class,
        ]);
    }
}
...
class RsPurchoffertransx extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'CAMPAIGN_INFOS' => \LogoObjects\Clients\salesContracts\RscollectionrsCampcodeslistxml::class,
            'DETAILS' => \LogoObjects\Clients\salesContracts\RscollectionrsPurchofferdetxml::class,
            'DEFNFLDS' => \LogoObjects\Clients\salesContracts\Rscollectionextendedfielddefinitions::class,
        ]);
    }
}
 ...
 * SalesContracts
 */
class SalesContracts extends \LogoObjects\Types\BaseEntity
{
    /** @var int|float|null */
    public $TRCODE = null;
    ...
    {
        return array_merge(parent::casts(), [
            'PAYMENT_LIST' => \LogoObjects\Clients\salesContracts\RscollectionrsPaylstxml::class,
            'TRANSACTIONS' => \LogoObjects\Clients\salesContracts\RscollectionrsPurchoffertransx::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\salesContracts\Rscollectionextendedfielddefinitions::class,
        ]);
    }
}
 ...
 */
class SalesContractsQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var SalesContractsSortSpec|null */
    public $sort = null;
}
 ...
 */
class SalesContractsSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class SalesContractsAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
