...
class RscollectionrsEximwhfclinexml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\exportMovementSlips\RsEximwhfclinexml::class],
        ]);
    }
}
...
class RscollectionrsSlloctrnxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\exportMovementSlips\RsSlloctrnxml::class],
        ]);
    }
}
...
class RscollectionrsQccvalentryxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\exportMovementSlips\RsQccvalentryxml::class],
        ]);
    }
}
...
class RscollectionrsQccvallistxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\exportMovementSlips\RsQccvallistxml::class],
        ]);
    }
}
...
class RscollectionrsEximwhfcdetxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\exportMovementSlips\RsEximwhfcdetxml::class],
        ]);
    }
}
...
class RsEximwhfclinexml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'SL_LINES' => \LogoObjects\Clients\exportMovementSlips\RscollectionrsSlloctrnxml::class,
            'DETAILS' => \LogoObjects\Clients\exportMovementSlips\RscollectionrsEximwhfcdetxml::class,
        ]);
    }
}
...
class RsSlloctrnxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'QCLIST' => \LogoObjects\Clients\exportMovementSlips\RscollectionrsQccvalentryxml::class,
        ]);
    }
}
...
class RsQccvalentryxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'VALLIST' => \LogoObjects\Clients\exportMovementSlips\RscollectionrsQccvallistxml::class,
        ]);
    }
}
 ...
 * ExportMovementSlips
 */
class ExportMovementSlips extends \LogoObjects\Types\BaseEntity
{
    /** @var int|float|null */
    public $TRCODE = null;
    ...
    {
        return array_merge(parent::casts(), [
            'TRANSACTIONS' => \LogoObjects\Clients\exportMovementSlips\RscollectionrsEximwhfclinexml::class,
        ]);
    }
}
 ...
 */
class ExportMovementSlipsQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var ExportMovementSlipsSortSpec|null */
    public $sort = null;
}
 ...
 */
class ExportMovementSlipsSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class ExportMovementSlipsAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
