...
class RscollectionrsExclistnodexml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\purchasedServicePrices\RsExclistnodexml::class],
        ]);
    }
}
...
class RscollectionrsExclistnodevalxm extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchasedServicePrices\RsExclistnodevalxm::class],
        ]);
    }
}
...
class RscollectionrsPrcdivlstxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchasedServicePrices\RsPrcdivlstxml::class],
        ]);
    }
}
...
class RsExclistnodexml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'VALREFSLIST' => \LogoObjects\Clients\purchasedServicePrices\RscollectionrsExclistnodevalxm::class,
        ]);
    }
}
 ...
 */
class PurchasedServicePrices extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'VGENXMLLIST' => \LogoObjects\Clients\purchasedServicePrices\RscollectionrsExclistnodexml::class,
            'DIVISION_LIST' => \LogoObjects\Clients\purchasedServicePrices\RscollectionrsPrcdivlstxml::class,
        ]);
    }
}
 ...
 */
class PurchasedServicePricesQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var PurchasedServicePricesSortSpec|null */
    public $sort = null;
}
 ...
 */
class PurchasedServicePricesSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class PurchasedServicePricesAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
