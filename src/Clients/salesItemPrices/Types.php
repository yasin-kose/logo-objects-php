...
class RscollectionrsExclistnodexml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\salesItemPrices\RsExclistnodexml::class],
        ]);
    }
}
...
class RscollectionrsExclistnodevalxm extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesItemPrices\RsExclistnodevalxm::class],
        ]);
    }
}
...
class RscollectionrsPrcdivlstxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesItemPrices\RsPrcdivlstxml::class],
        ]);
    }
}
...
class RsExclistnodexml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'VALREFSLIST' => \LogoObjects\Clients\salesItemPrices\RscollectionrsExclistnodevalxm::class,
        ]);
    }
}
 ...
 * SalesItemPrices
 */
class SalesItemPrices extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'VGENXMLLIST' => \LogoObjects\Clients\salesItemPrices\RscollectionrsExclistnodexml::class,
            'DIVISION_LIST' => \LogoObjects\Clients\salesItemPrices\RscollectionrsPrcdivlstxml::class,
        ]);
    }
}
 ...
 */
class SalesItemPricesQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var SalesItemPricesSortSpec|null */
    public $sort = null;
}
 ...
 */
class SalesItemPricesSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class SalesItemPricesAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
