...
class RscollectionrsPaylstxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\purchaseProposalContracts\RsPaylstxml::class],
        ]);
    }
}
...
class RscollectionrsDiscpaytrxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchaseProposalContracts\RsDiscpaytrxml::class],
        ]);
    }
}
...
class RscollectionrsPurchoffertransx extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchaseProposalContracts\RsPurchoffertransx::class],
        ]);
    }
}
...
class RscollectionrsCampcodeslistxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchaseProposalContracts\RsCampcodeslistxml::class],
        ]);
    }
}
...
class RscollectionrsPurchofferdetxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchaseProposalContracts\RsPurchofferdetxml::class],
        ]);
    }
}
...
class Rscollectionextendedfielddefinitions extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\purchaseProposalContracts\ExtendedFieldDefinitions::class],
        ]);
    }
}
...
class RsPaylstxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'DISCTRLIST' => \LogoObjects\Clients\purchaseProposalContracts\RscollectionrsDiscpaytrxml::class,
        ]);
    }
}
...
class RsPurchoffertransx extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'CAMPAIGN_INFOS' => \LogoObjects\Clients\purchaseProposalContracts\RscollectionrsCampcodeslistxml::class,
            'DETAILS' => \LogoObjects\Clients\purchaseProposalContracts\RscollectionrsPurchofferdetxml::class,
            'DEFNFLDS' => \LogoObjects\Clients\purchaseProposalContracts\Rscollectionextendedfielddefinitions::class,
        ]);
    }
}
 ...
 */
class PurchaseProposalContracts extends \LogoObjects\Types\BaseEntity
{
    /** @var int|float|null */
    public $TRCODE = null;
    ...
    /** @var int|float|null */
    public $CHECKPRICE = null;
    /** @var int|float|null */
    public $CHECKTOTAL = null;
    /** @var int|float|null */
    public $DEFAULTFICHE = null;
    ...
    {
        return array_merge(parent::casts(), [
            'PAYMENT_LIST' => \LogoObjects\Clients\purchaseProposalContracts\RscollectionrsPaylstxml::class,
            'TRANSACTIONS' => \LogoObjects\Clients\purchaseProposalContracts\RscollectionrsPurchoffertransx::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\purchaseProposalContracts\Rscollectionextendedfielddefinitions::class,
        ]);
    }
}
 ...
 */
class PurchaseProposalContractsQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var PurchaseProposalContractsSortSpec|null */
    public $sort = null;
}
 ...
 */
class PurchaseProposalContractsSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class PurchaseProposalContractsAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
