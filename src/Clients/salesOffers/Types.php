...
class RscollectionrsPaylstxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\salesOffers\RsPaylstxml::class],
        ]);
    }
}
...
class RscollectionrsDiscpaytrxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOffers\RsDiscpaytrxml::class],
        ]);
    }
}
...
class RscollectionrsPurchoffertransx extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOffers\RsPurchoffertransx::class],
        ]);
    }
}
...
class RscollectionrsCampcodeslistxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOffers\RsCampcodeslistxml::class],
        ]);
    }
}
...
class RscollectionrsPurchofferdetxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOffers\RsPurchofferdetxml::class],
        ]);
    }
}
...
class Rscollectionextendedfielddefinitions extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOffers\ExtendedFieldDefinitions::class],
        ]);
    }
}
...
class RsPaylstxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'DISCTRLIST' => \LogoObjects\Clients\salesOffers\RscollectionrsDiscpaytrxml::class,
        ]);
    }
}
...
class RsPurchoffertransx extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'CAMPAIGN_INFOS' => \LogoObjects\Clients\salesOffers\RscollectionrsCampcodeslistxml::class,
            'DETAILS' => \LogoObjects\Clients\salesOffers\RscollectionrsPurchofferdetxml::class,
            'DEFNFLDS' => \LogoObjects\Clients\salesOffers\Rscollectionextendedfielddefinitions::class,
        ]);
    }
}
 ...
 * SalesOffers
 */
class SalesOffers extends \LogoObjects\Types\BaseEntity
{
    /** @var int|float|null */
    public $TRCODE = null;
    ...
    {
        return array_merge(parent::casts(), [
            'PAYMENT_LIST' => \LogoObjects\Clients\salesOffers\RscollectionrsPaylstxml::class,
            'TRANSACTIONS' => \LogoObjects\Clients\salesOffers\RscollectionrsPurchoffertransx::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\salesOffers\Rscollectionextendedfielddefinitions::class,
        ]);
    }
}
 ...
 */
class SalesOffersQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var SalesOffersSortSpec|null */
    public $sort = null;
}
 ...
 */
class SalesOffersSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class SalesOffersAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
