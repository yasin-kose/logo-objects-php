...
class RscollectionrsCamplinesxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\purchaseCampaigns\RsCamplinesxml::class],
        ]);
    }
}
 ...
 * PurchaseCampaigns
 */
class PurchaseCampaigns extends \LogoObjects\Types\BaseEntity
{
    /** @var int|float|null */
    ...
    {
        return array_merge(parent::casts(), [
            'CAMPAIGN_LINES' => \LogoObjects\Clients\purchaseCampaigns\RscollectionrsCamplinesxml::class,
        ]);
    }
}
 ...
 */
class PurchaseCampaignsQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var PurchaseCampaignsSortSpec|null */
    public $sort = null;
}
 ...
 */
class PurchaseCampaignsSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class PurchaseCampaignsAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
