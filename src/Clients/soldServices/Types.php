...
class RscollectionrsSrvinvenxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\soldServices\RsSrvinvenxml::class],
        ]);
    }
}
...
class RscollectionrsServunitasgn extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\soldServices\RsServunitasgn::class],
        ]);
    }
}
...
class RscollectionrsGlpostxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\soldServices\RsGlpostxml::class],
        ]);
    }
}
...
class RscollectionrsAddtaxmultixml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\soldServices\RsAddtaxmultixml::class],
        ]);
    }
}
 ...
 * SoldServices
 */
class SoldServices extends \LogoObjects\Types\BaseEntity
{
    /** @var int|float|null */
    public $CARD_TYPE = null;
    ...
    {
        return array_merge(parent::casts(), [
            'WH_PARAMS' => \LogoObjects\Clients\soldServices\RscollectionrsSrvinvenxml::class,
            'UNITS' => \LogoObjects\Clients\soldServices\RscollectionrsServunitasgn::class,
            'GL_LINKS' => \LogoObjects\Clients\soldServices\RscollectionrsGlpostxml::class,
            'ADDTAXLIST' => \LogoObjects\Clients\soldServices\RscollectionrsAddtaxmultixml::class,
        ]);
    }
}
 ...
 */
class SoldServicesQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var SoldServicesSortSpec|null */
    public $sort = null;
}
 ...
 */
class SoldServicesSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class SoldServicesAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
