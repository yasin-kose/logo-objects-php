...
class RscollectionrsCostdisttrans extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\salesProvisionDistributionSlips\RsCostdisttrans::class],
        ]);
    }
}
...
class RscollectionrsCostdistpeg extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesProvisionDistributionSlips\RsCostdistpeg::class],
        ]);
    }
}
...
class RsCostdisttrans extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'PEGLINELIST' => \LogoObjects\Clients\salesProvisionDistributionSlips\RscollectionrsCostdistpeg::class,
        ]);
    }
}
 ...
 */
class SalesProvisionDistributionSlips extends \LogoObjects\Types\BaseEntity
{
    public ?string $FICHENO = null;
    public ?string $DATE = null;
    /** @var int|float|null */
    ...
    {
        return array_merge(parent::casts(), [
            'TRANSACTIONS' => \LogoObjects\Clients\salesProvisionDistributionSlips\RscollectionrsCostdisttrans::class,
            'CURREDLNPEGLIST' => \LogoObjects\Clients\salesProvisionDistributionSlips\RscollectionrsCostdistpeg::class,
        ]);
    }
}
 ...
 */
class SalesProvisionDistributionSlipsQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var SalesProvisionDistributionSlipsSortSpec|null */
    public $sort = null;
}
 ...
 */
class SalesProvisionDistributionSlipsSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class SalesProvisionDistributionSlipsAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
