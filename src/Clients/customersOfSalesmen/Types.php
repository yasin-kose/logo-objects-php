...
class RscollectionrsSlsclrelxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\customersOfSalesmen\RsSlsclrelxml::class],
        ]);
    }
}
 ...
 * CustomersOfSalesmen
 */
class CustomersOfSalesmen extends \LogoObjects\Types\BaseEntity
{
    public ?string $CODE = null;
    public ?string $NAME = null;
    /** @var int|float|null */
    ...
    {
        return array_merge(parent::casts(), [
            'CL_LIST' => \LogoObjects\Clients\customersOfSalesmen\RscollectionrsSlsclrelxml::class,
        ]);
    }
}
 ...
 */
class CustomersOfSalesmenQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var CustomersOfSalesmenSortSpec|null */
    public $sort = null;
}
 ...
 */
class CustomersOfSalesmenSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class CustomersOfSalesmenAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
