...
class RscollectionrsRelateddocxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\exportCreditLetters\RsRelateddocxml::class],
        ]);
    }
}
 ...
 * ExportCreditLetters
 */
class ExportCreditLetters extends \LogoObjects\Types\BaseEntity
{
    /** @var int|float|null */
    public $TYP = null;
    ...
    {
        return array_merge(parent::casts(), [
            'RELATED_DOCUMENTS' => \LogoObjects\Clients\exportCreditLetters\RscollectionrsRelateddocxml::class,
        ]);
    }
}
 ...
 */
class ExportCreditLettersQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var ExportCreditLettersSortSpec|null */
    public $sort = null;
}
 ...
 */
class ExportCreditLettersSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class ExportCreditLettersAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
