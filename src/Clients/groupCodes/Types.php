 ...
 * GroupCodes
 */
class GroupCodes extends \LogoObjects\Types\BaseEntity
{
    /** @var int|float|null */
 ...
 */
class GroupCodesQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var GroupCodesSortSpec|null */
    public $sort = null;
}
 ...
 */
class GroupCodesSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 * GroupCodesAnalytics
 */
class GroupCodesAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
