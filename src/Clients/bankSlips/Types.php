...
namespace LogoObjects\Clients\bankSlips;
...
class RscollectionrsBanktransxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\bankSlips\RsBanktransxml::class],
        ]);
    }
}
...
class RscollectionrsPaylstxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsPaylstxml::class],
        ]);
    }
}
...
class RscollectionrsDiscpaytrxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsDiscpaytrxml::class],
        ]);
    }
}
...
class Rscollectionextendedfielddefinitions extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\ExtendedFieldDefinitions::class],
        ]);
    }
}
...
class RscollectionrsPreaccdistlnxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsPreaccdistlnxml::class],
        ]);
    }
}
...
class Rscollectionpurchaseinvoices extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\PurchaseInvoices::class],
        ]);
    }
}
...
class Rscollectionpurchasedispatches extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\PurchaseDispatches::class],
        ]);
    }
}
...
class RscollectionrsDesptransxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsDesptransxml::class],
        ]);
    }
}
...
class RscollectionrsFaregtrnxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsFaregtrnxml::class],
        ]);
    }
}
...
class RscollectionrsSlloctrnxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsSlloctrnxml::class],
        ]);
    }
}
...
class RscollectionrsQccvalentryxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsQccvalentryxml::class],
        ]);
    }
}
...
class RscollectionrsQccvallistxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsQccvallistxml::class],
        ]);
    }
}
...
class RscollectionrsDetmattrxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsDetmattrxml::class],
        ]);
    }
}
...
class RscollectionrsCampcodeslistxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsCampcodeslistxml::class],
        ]);
    }
}
...
class RscollectionrsAddtaxmultilinex extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsAddtaxmultilinex::class],
        ]);
    }
}
...
class RscollectionrsLabelxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsLabelxml::class],
        ]);
    }
}
...
class RscollectionrsIntellistxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsIntellistxml::class],
        ]);
    }
}
...
class RscollectionrsOkcinfoxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsOkcinfoxml::class],
        ]);
    }
}
...
class Rscollectionchequeandpnoterolls extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\ChequeAndPnoteRolls::class],
        ]);
    }
}
...
class RscollectionrsChqpntransxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsChqpntransxml::class],
        ]);
    }
}
...
class RscollectionrsChqpnstatxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsChqpnstatxml::class],
        ]);
    }
}
...
class RscollectionrsArptransxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsArptransxml::class],
        ]);
    }
}
...
class RscollectionrsBankcrepayxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsBankcrepayxml::class],
        ]);
    }
}
...
class Arps extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'Meta' => \LogoObjects\Types\Meta::class,
            'NOTES' => \LogoObjects\Clients\bankSlips\RscollectionrsArpnotesxml::class,
            'GENIUSFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
        ]);
    }
}
...
class RscollectionrsArpnotesxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsArpnotesxml::class],
        ]);
    }
}
...
class PurchasedServices extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'DataObjectParameter' => \LogoObjects\Types\DataObjectParameter::class,
            'Meta' => \LogoObjects\Types\Meta::class,
            'WH_PARAMS' => \LogoObjects\Clients\bankSlips\RscollectionrsSrvinvenxml::class,
            'UNITS' => \LogoObjects\Clients\bankSlips\RscollectionrsServunitasgn::class,
            'GL_LINKS' => \LogoObjects\Clients\bankSlips\RscollectionrsGlpostxml::class,
            'ADDTAXLIST' => \LogoObjects\Clients\bankSlips\RscollectionrsAddtaxmultixml::class,
        ]);
    }
}
...
class RscollectionrsSrvinvenxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsSrvinvenxml::class],
        ]);
    }
}
...
class RscollectionrsServunitasgn extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsServunitasgn::class],
        ]);
    }
}
...
class RscollectionrsGlpostxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsGlpostxml::class],
        ]);
    }
}
...
class RscollectionrsAddtaxmultixml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsAddtaxmultixml::class],
        ]);
    }
}
...
class Items extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'DataObjectParameter' => \LogoObjects\Types\DataObjectParameter::class,
            'Meta' => \LogoObjects\Types\Meta::class,
            'FACTORY_PARAMS' => \LogoObjects\Clients\bankSlips\RscollectionrsItemfactoryxml::class,
            'WH_PARAMS' => \LogoObjects\Clients\bankSlips\RscollectionrsIteminvenxml::class,
            'CHARACTERISTICS' => \LogoObjects\Clients\bankSlips\RscollectionrsItemchcodesxml::class,
            'DOMINANT_CLASSES' => \LogoObjects\Clients\bankSlips\RscollectionrsXmldomcls::class,
            'UNITS' => \LogoObjects\Clients\bankSlips\RscollectionrsItemunitasgn::class,
            'COMPOSITES' => \LogoObjects\Clients\bankSlips\RscollectionrsItemcmpxml::class,
            'GL_LINKS' => \LogoObjects\Clients\bankSlips\RscollectionrsGlpostxml::class,
            'SUPPLIERS' => \LogoObjects\Clients\bankSlips\RscollectionrsItemsuppxml::class,
            'ADDTAXLIST' => \LogoObjects\Clients\bankSlips\RscollectionrsAddtaxmultixml::class,
            'QPRODS' => \LogoObjects\Clients\bankSlips\RscollectionrsItemqprodxml::class,
            'QPRODSUBCONTS' => \LogoObjects\Clients\bankSlips\RscollectionrsItemqprodxml::class,
            'GENIUSFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
            'VRNTEXCEPTIONS' => \LogoObjects\Clients\bankSlips\RscollectionrsExclistnodexml::class,
            'VRNTCODETEMPS' => \LogoObjects\Clients\bankSlips\RscollectionrsVrntcdtemplatexm::class,
            'VRNTEXCPTEMPS' => \LogoObjects\Clients\bankSlips\RscollectionrsVrntcdtemplatexm::class,
            'ALTERNATIVES' => \LogoObjects\Clients\bankSlips\Rscollectionitemalternatives::class,
            'LABEL_LIST' => \LogoObjects\Clients\bankSlips\RscollectionrsLabelxml::class,
        ]);
    }
}
...
class RscollectionrsItemfactoryxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsItemfactoryxml::class],
        ]);
    }
}
...
class RscollectionrsIteminvenxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsIteminvenxml::class],
        ]);
    }
}
...
class RscollectionrsItemchcodesxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsItemchcodesxml::class],
        ]);
    }
}
...
class RsItemchcodesxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'DataObjectParameter' => \LogoObjects\Types\DataObjectParameter::class,
            'Meta' => \LogoObjects\Types\Meta::class,
            'VALUES' => \LogoObjects\Clients\bankSlips\RscollectionrsItemchvaluesxml::class,
        ]);
    }
}
...
class RscollectionrsItemchvaluesxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsItemchvaluesxml::class],
        ]);
    }
}
...
class RscollectionrsXmldomcls extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsXmldomcls::class],
        ]);
    }
}
...
class RscollectionrsItemunitasgn extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsItemunitasgn::class],
        ]);
    }
}
...
class RsItemunitasgn extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'DataObjectParameter' => \LogoObjects\Types\DataObjectParameter::class,
            'Meta' => \LogoObjects\Types\Meta::class,
            'BARCODE_LIST' => \LogoObjects\Clients\bankSlips\RscollectionrsBarcodexml::class,
        ]);
    }
}
...
class RscollectionrsBarcodexml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsBarcodexml::class],
        ]);
    }
}
...
class RscollectionrsItemcmpxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsItemcmpxml::class],
        ]);
    }
}
...
class RscollectionrsItemsuppxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsItemsuppxml::class],
        ]);
    }
}
...
class RscollectionrsItemqprodxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsItemqprodxml::class],
        ]);
    }
}
...
class RscollectionrsExclistnodexml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsExclistnodexml::class],
        ]);
    }
}
...
class RsExclistnodexml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'DataObjectParameter' => \LogoObjects\Types\DataObjectParameter::class,
            'Meta' => \LogoObjects\Types\Meta::class,
            'VALREFSLIST' => \LogoObjects\Clients\bankSlips\RscollectionrsExclistnodevalxm::class,
        ]);
    }
}
...
class RscollectionrsExclistnodevalxm extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsExclistnodevalxm::class],
        ]);
    }
}
...
class RscollectionrsVrntcdtemplatexm extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsVrntcdtemplatexm::class],
        ]);
    }
}
...
class RsVrntcdtemplatexm extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'DataObjectParameter' => \LogoObjects\Types\DataObjectParameter::class,
            'Meta' => \LogoObjects\Types\Meta::class,
            'TEMPVALS' => \LogoObjects\Clients\bankSlips\RscollectionrsVrntcdtempvaluex::class,
        ]);
    }
}
...
class RscollectionrsVrntcdtempvaluex extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\RsVrntcdtempvaluex::class],
        ]);
    }
}
...
class Rscollectionitemalternatives extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\bankSlips\ItemAlternatives::class],
        ]);
    }
}
...
class RsBanktransxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'PAYMENT_LIST' => \LogoObjects\Clients\bankSlips\RscollectionrsPaylstxml::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
            'PREACCLINES' => \LogoObjects\Clients\bankSlips\RscollectionrsPreaccdistlnxml::class,
        ]);
    }
}
...
class RsPaylstxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'DISCTRLIST' => \LogoObjects\Clients\bankSlips\RscollectionrsDiscpaytrxml::class,
        ]);
    }
}
...
class PurchaseInvoices extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'DISPATCHES' => \LogoObjects\Clients\bankSlips\Rscollectionpurchasedispatches::class,
            'TRANSACTIONS' => \LogoObjects\Clients\bankSlips\RscollectionrsDesptransxml::class,
            'PAYMENT_LIST' => \LogoObjects\Clients\bankSlips\RscollectionrsPaylstxml::class,
            'GENIUSFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
            'INTEL_LIST' => \LogoObjects\Clients\bankSlips\RscollectionrsIntellistxml::class,
            'PREACCLINES' => \LogoObjects\Clients\bankSlips\RscollectionrsPreaccdistlnxml::class,
            'OKCINFO_LIST' => \LogoObjects\Clients\bankSlips\RscollectionrsOkcinfoxml::class,
            'LABEL_LIST' => \LogoObjects\Clients\bankSlips\RscollectionrsLabelxml::class,
        ]);
    }
}
...
class RsDesptransxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'FA_INFO' => \LogoObjects\Clients\bankSlips\RscollectionrsFaregtrnxml::class,
            'SL_DETAILS' => \LogoObjects\Clients\bankSlips\RscollectionrsSlloctrnxml::class,
            'DETAILS' => \LogoObjects\Clients\bankSlips\RscollectionrsDetmattrxml::class,
            'QCLIST' => \LogoObjects\Clients\bankSlips\RscollectionrsQccvalentryxml::class,
            'CAMPAIGN_INFOS' => \LogoObjects\Clients\bankSlips\RscollectionrsCampcodeslistxml::class,
            'ADDTAXLINELIST' => \LogoObjects\Clients\bankSlips\RscollectionrsAddtaxmultilinex::class,
            'GENIUSFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
            'FAREGDEFNFLDLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
            'PREACCLINES' => \LogoObjects\Clients\bankSlips\RscollectionrsPreaccdistlnxml::class,
        ]);
    }
}
...
class RsQccvalentryxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'VALLIST' => \LogoObjects\Clients\bankSlips\RscollectionrsQccvallistxml::class,
        ]);
    }
}
...
class ChequeAndPnoteRolls extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'TRANSACTIONS' => \LogoObjects\Clients\bankSlips\RscollectionrsChqpntransxml::class,
            'ARP_TRANSACTIONS' => \LogoObjects\Clients\bankSlips\RscollectionrsArptransxml::class,
            'BANK_TRANSACTIONS' => \LogoObjects\Clients\bankSlips\RscollectionrsBanktransxml::class,
            'PAYMENT_LIST' => \LogoObjects\Clients\bankSlips\RscollectionrsPaylstxml::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
        ]);
    }
...
class RsChqpntransxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'STATUS_LIST' => \LogoObjects\Clients\bankSlips\RscollectionrsChqpnstatxml::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
        ]);
    }
}
 ...
 * BankSlips
 */
class BankSlips extends \LogoObjects\Types\BaseEntity
{
    public ?string $DATE = null;
    /** @var int|float|null */
    public $TIME = null;
    ...
    public $ACC_FICHE_SITEID = null;
    /** @var int|float|null */
    public $COLLATRL_CARD_REF = null;
    /** @var int|float|null */
    public $COLLATRL_CARD_SITEID = null;
    /** @var int|float|null */
    public $SALESMANREF = null;
    public ?string $SALESMAN_CODE = null;
    /** @var int|float|null */
    public $CRCARD_FICHEREF = null;
    /** @var int|float|null */
    public $FROM_CREDIT_CLOSE = null;
    /** @var int|float|null */
    public $FROM_CURR_DIFF_PROC = null;
    /** @var int|float|null */
    public $FROM_CR_STRUCT = null;
    /** @var int|float|null */
    public $STATUS = null;
    /** @var int|float|null */
    public $CANCEL_AUTO_GL_PROC = null;
    /** @var RscollectionrsBankcrepayxml|null */
    public $BNCREPAYMENTLIST = null;
    public ?string $EBOOK_DOCDATE = null;
    /** @var int|float|null */
    public $EBOOK_NODOCUMENT = null;
    public ?string $EBOOK_DOCNR = null;
    ...
    {
        return array_merge(parent::casts(), [
            'TRANSACTIONS' => \LogoObjects\Clients\bankSlips\RscollectionrsBanktransxml::class,
            'ATTACHMENT_INVOICE' => \LogoObjects\Clients\bankSlips\Rscollectionpurchaseinvoices::class,
            'ATTACHMENT_ROLL' => \LogoObjects\Clients\bankSlips\Rscollectionchequeandpnoterolls::class,
            'BNCREPAYMENTLIST' => \LogoObjects\Clients\bankSlips\RscollectionrsBankcrepayxml::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\bankSlips\Rscollectionextendedfielddefinitions::class,
        ]);
    }
}
 ...
 */
class BankSlipsQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var BankSlipsSortSpec|null */
    public $sort = null;
}
 ...
 */
class BankSlipsSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
    ...
    /** @var mixed */
    public $collatrlRolltrnsref = null;
    /** @var mixed */
    public $bncreref = null;
    /** @var mixed */
    ...
    /** @var mixed */
    public $collatrlCardRef = null;
    /** @var mixed */
    public $collatrlCardSiteid = null;
    /** @var mixed */
    public $salesmanref = null;
    /** @var mixed */
    public $salesmanCode = null;
    /** @var mixed */
    public $crcardFicheref = null;
    /** @var mixed */
    public $fromCreditClose = null;
    /** @var mixed */
    public $fromCurrDiffProc = null;
    /** @var mixed */
    public $fromCrStruct = null;
    /** @var mixed */
    public $status = null;
    /** @var mixed */
 ...
 * BankSlipsAnalytics
 */
class BankSlipsAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
