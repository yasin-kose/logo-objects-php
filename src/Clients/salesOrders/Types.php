...
namespace LogoObjects\Clients\salesOrders;
...
class RscollectionrsOrdtransxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            ...
            'items' => [\LogoObjects\Clients\salesOrders\RsOrdtransxml::class],
        ]);
    }
}
...
class RscollectionrsOrddettrnxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOrders\RsOrddettrnxml::class],
        ]);
    }
}
...
class RscollectionrsCampcodeslistxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOrders\RsCampcodeslistxml::class],
        ]);
    }
}
...
class Rscollectionextendedfielddefinitions extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOrders\ExtendedFieldDefinitions::class],
        ]);
    }
}
...
class RscollectionrsAddtaxmultilinex extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOrders\RsAddtaxmultilinex::class],
        ]);
    }
}
...
class RscollectionrsPaylstxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOrders\RsPaylstxml::class],
        ]);
    }
}
...
class RscollectionrsDiscpaytrxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOrders\RsDiscpaytrxml::class],
        ]);
    }
}
...
class Rscollectiondemandpeggings extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOrders\DemandPeggings::class],
        ]);
    }
}
...
class RscollectionrsLabelxml extends \LogoObjects\Support\Entity
{
    ...
    protected static function casts(): array
    {
        return array_merge(parent::casts(), [
            'Meta' => \LogoObjects\Types\Meta::class,
            'items' => [\LogoObjects\Clients\salesOrders\RsLabelxml::class],
        ]);
    }
}
...
class RsOrdtransxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'DETAILS' => \LogoObjects\Clients\salesOrders\RscollectionrsOrddettrnxml::class,
            'CAMPAIGN_INFOS' => \LogoObjects\Clients\salesOrders\RscollectionrsCampcodeslistxml::class,
            'DEFNFLDS' => \LogoObjects\Clients\salesOrders\Rscollectionextendedfielddefinitions::class,
            'ADDTAXLINELIST' => \LogoObjects\Clients\salesOrders\RscollectionrsAddtaxmultilinex::class,
        ]);
    }
}
...
class RsPaylstxml extends \LogoObjects\Types\BaseEntity
{
    ...
    {
        return array_merge(parent::casts(), [
            'DISCTRLIST' => \LogoObjects\Clients\salesOrders\RscollectionrsDiscpaytrxml::class,
        ]);
    }
}
 ...
 * SalesOrders
 */
class SalesOrders extends \LogoObjects\Types\BaseEntity
{
    /** @var int|float|null */
    public $TYPE = null;
    ...
    {
        return array_merge(parent::casts(), [
            'TRANSACTIONS' => \LogoObjects\Clients\salesOrders\RscollectionrsOrdtransxml::class,
            'PAYMENT_LIST' => \LogoObjects\Clients\salesOrders\RscollectionrsPaylstxml::class,
            'DEFNFLDSLIST' => \LogoObjects\Clients\salesOrders\Rscollectionextendedfielddefinitions::class,
            'DEMANDPEGGINGS' => \LogoObjects\Clients\salesOrders\Rscollectiondemandpeggings::class,
            'LABEL_LIST' => \LogoObjects\Clients\salesOrders\RscollectionrsLabelxml::class,
        ]);
    }
}
 ...
 */
class SalesOrdersQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var SalesOrdersSortSpec|null */
    public $sort = null;
}
 ...
 */
class SalesOrdersSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class SalesOrdersAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
