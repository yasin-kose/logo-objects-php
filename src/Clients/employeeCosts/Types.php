 ...
 * EmployeeCosts
 */
class EmployeeCosts extends \LogoObjects\Types\BaseEntity
{
    /** @var int|float|null */
    public $RESTYPE = null;
    /** @var int|float|null */
 ...
 */
class EmployeeCostsQueryOptions extends \LogoObjects\Support\Entity
{
    public ?array $fields = null;
    /** @var EmployeeCostsSortSpec|null */
    public $sort = null;
}
 ...
 */
class EmployeeCostsSearchCriteria extends \LogoObjects\Support\Entity
{
    /** @var mixed */
 ...
 */
class EmployeeCostsAnalytics extends \LogoObjects\Support\Entity
{
    /** @var int|float|null */
    public $total = null;
}
